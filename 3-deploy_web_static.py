...
def do_pack():
    """This func creates a tar gzipped archive of the directory web_static."""
    dt = datetime.utcnow()
...
def do_deploy(archive_path):
    """This func distributes an archive to a web server.
...
def deploy():
    """This func distributes the archive to a web server."""
    file = do_pack()
    if file is None:
        return False
